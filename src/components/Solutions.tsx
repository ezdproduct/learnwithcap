            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
                    <div className="lg:col-span-2 flex flex-col gap-6 items-start text-left">
                        <span className="bg-[#59B4E9] text-white text-[12px] font-bold px-3 py-1.5 rounded-[8px] uppercase tracking-[0.1em] mb-2.5">
                ...
                <div ref={containerRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 reveal-piano">
                    {solutions.map((item, idx) => (
                        <div
                            key={idx}
                            className="piano-item p-4 rounded-3xl bg-[#001e3d] border border-white/10 hover:border-white/20 transition-colors duration-300 h-full flex flex-col items-start text-left group"
                        >
