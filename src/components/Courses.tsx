                    ...
                    <div className="container mx-auto px-5 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-[3fr_7fr] gap-16 items-start">
                            <div className="section-header reveal-staggered">
                                <span className="bg-[#59B4E9] text-white text-[12px] font-bold px-3 py-1.5 rounded-[8px] uppercase tracking-[0.1em] mb-4 inline-block">
                                    KHÓA HỌC
                                </span>
                            ...
                            <div className="text-sm text-white/80 space-y-4 max-w-2xl mx-auto">
                                ...
                                <button className="mt-4 px-6 py-2 bg-[#59B4E9] text-white font-bold rounded text-sm hover:bg-[#2b8ac6] transition">
                                    Tư Vấn Ngay
                                </button>
                            </div>
                        </div>
